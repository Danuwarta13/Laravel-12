 <x-layout :title="$title">
     ...
     <div class="text-base text-gray-500">
         <a href="#">{{ $post->author->name }}</a> | 10 Desember 2025
     </div>
     ...
     <main class="pt-8 pb-16 lg:pt-16 lg:pb-24 rounded bg-white dark:bg-gray-900 antialiased">
                 ...
                 <header class="my-4 lg:mb-6 not-format">
                     <address class="flex items-center mb-6 not-italic">
                         <div class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                             ...
                             <div>
                                 <a href="/posts?author={{ $post->author->username }}" rel="author" class="block text-xl font-bold text-gray-900 mb-1 hover:underline dark:text-white">{{ $post->author->name }}</a>
